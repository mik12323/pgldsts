...
<head>
    ...
    <link rel="icon" href="{{ asset('img/titleLogo.png') }}" type="image/icon type">
...
{{-- Navbar --}}
    <nav class="navbar navbar-expand-md navbar-light text-dark" style="background-color: #5fd1b8">
        ...
        <div class="mt-1">
            <h6>Provincial Capitol of <span style="color: #ff7260;">Lanao del Sur</span> Database System</h6>
        </div>
        <div class="container">
    ...
    <footer class="text-center text-white fixed-bottom">
        ...
        <div class="text-center p-3 d-flex justify-content-center" style="background-color: #5fd1b8;">
           <p class="text-dark mb-0">Provincial Capitol of Lanao del Sur</p>
        </div>
        <!-- Copyright -->
        </footer>
